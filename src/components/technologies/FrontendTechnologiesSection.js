  ...
  return (
    <section className="w-full py-8 sm:py-12 md:py-16 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-white text-xl sm:text-2xl md:text-3xl font-semibold mb-6 sm:mb-7 md:mb-8">Frontend Technologies</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-5 md:gap-6">
          {technologies.map((tech) => (
            ...
            >
              ...
              <h3 className="text-white text-xs sm:text-sm md:text-base font-medium">{tech.name}</h3>
            </div>
          ))}
        </div>
      </div>
