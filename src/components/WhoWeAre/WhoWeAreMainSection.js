      ...
      >
        ...
        <div className="flex flex-col justify-center align-center gap-4 sm:gap-5 md:gap-6 lg:gap-[20px] w-full lg:w-[598px]">
          ...
          <p className="font-inter font-normal text-[#E6E6E6] text-base sm:text-lg md:text-xl lg:text-[22px] leading-[140%] sm:leading-[150%]">
            At Codroon, we create technology that moves businesses forward. Operating across the USA and South Asia, we specialize in building AI-driven solutions, scalable digital platforms, and custom software that empower organizations to grow faster and smarter. Our approach is simple: focus, speed, and impact. By blending innovation with execution, we deliver results that redefine what's possible in tech partnerships.
          </p>
        </div>
