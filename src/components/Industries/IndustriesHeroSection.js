...
export default function IndustriesHeroSection() {
  return (
    <section className="relative w-full h-[200px] sm:h-[320px] md:h-[400px] lg:h-[488px] flex items-center justify-center overflow-hidden mt-[60px] sm:mt-[80px] md:mt-[100px]">
