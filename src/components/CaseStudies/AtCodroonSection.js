      ...
      <MarginWrapper top={0} bottom={96}>
        <div className="w-full max-w-[1597px] mx-auto relative px-4 sm:px-6 md:px-8">
          ...
          >
            ...
            {/* Button */}
            <button 
              className="text-white font-barlow font-semibold transition-all duration-200 flex items-center justify-center rounded-[30px] w-full sm:w-auto sm:max-w-[446px] h-10 sm:h-12 md:h-14 lg:h-[50px] px-4 sm:px-6 md:px-[14px] py-2 sm:py-3 md:py-[12px] gap-2 sm:gap-[10px]"
              style={{ 
